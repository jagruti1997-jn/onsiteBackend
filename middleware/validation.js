...
const workersValidationRules = () => {
  return [
    body('Name')
      .notEmpty()
      .isString()
      .withMessage('workers name cannot be empty'),
...
const categoryValidationRules = () => {
  return [
    ...
    body('CategoryUnit')
      .notEmpty()
      .withMessage('Category unit cannot be empty'),
  ]
}
...
const requestValidationRules = () => {
  return [
    body('ItemQuantity')
      .notEmpty()
      .isNumeric()
      .withMessage('ItemQuantity cannot be empty'),
...
const fileValidationRules = () => {
  return [body('Name').notEmpty().withMessage('vendor Name cannot be empty')]
}
